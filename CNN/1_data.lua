...
trainData = {
   data = loader.data[{{1,60000}}];
   labels = loader.labels[{{1,60000}}];
   size = function() return 60000 end
}

testData = {
   data = loader.data[{{60001,loader.data:size(1)}}];
   labels = loader.labels[{{60001,loader.data:size(1)}}];
   size = function() return loader.data:size(1) - 60000 end
}
...
--    testData.data[i] = image.rgb2y(testData.data[i])
-- end
