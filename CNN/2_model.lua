...
elseif opt.model == 'convnet' then
   ...
   if opt.type == 'cuda' then
      ...
      model:add(cudnn.SpatialConvolution(1,32,5,5))
      ...
      model:add(cudnn.ReLU())
      model:add(cudnn.SpatialMaxPooling(2,2,2,2))
      model:add(cudnn.SpatialConvolution(16,16,3,3))
      model:add(cudnn.ReLU())
      model:add(cudnn.SpatialMaxPooling(2,2,2,2))
      model:add(nn.View(2240))
      model:add(nn.Dropout(0.2))
      model:add(nn.Linear(2240,1000))
      model:add(cudnn.ReLU())
      model:add(nn.Dropout(0.2))
      ...
      model:get(23).weight:zero()
      model:get(23).bias:zero()
